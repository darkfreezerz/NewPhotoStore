 ...
 * @author niponsarikan
 */
@WebServlet(name = "RemoveProtoServlet", urlPatterns = {"/removephotoservlet.do"})
public class RemoveProtoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            manage.removeProduct(product.getId());
